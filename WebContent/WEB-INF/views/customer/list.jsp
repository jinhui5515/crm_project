			...
			<c:forEach var="customer" items="${page.content }" >
				<tr>
					...
					<td class="list_data_op">
						<img onclick="window.location.href='${ctp}/customer/create?id=${customer.id}&pageNo=${pageNo }'"
							title="编辑" src="${ctp }/static/images/bt_edit.gif" class="op_button" alt="" /> 
						<img onclick="window.location.href='${ctp}/contact?id=${customer.id }'"
							title="联系人" src="${ctp }/static/images/bt_linkman.gif" class="op_button" alt="联系人信息" /> 
						<img onclick="window.location.href='${ctp}/activity?id=${customer.id }'"
							title="交往记录" src="${ctp }/static/images/bt_acti.gif" class="op_button" alt="交往记录" /> 
						<img onclick="window.location.href='${ctp}/order/list?id=${customer.id }'"
							title="历史订单" src="${ctp }/static/images/bt_orders.gif" class="op_button" alt="历史订单" /> 
							<c:if test="${customer.state != '删除' }">
								<img onclick="window.location.href='${ctp}/customer/delete?id=${customer.id}&pageNo=${page.pageNo }'" 
