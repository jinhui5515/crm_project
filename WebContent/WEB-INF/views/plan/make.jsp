...
<head>
	...
	$(function(){
		...
		$("button[id^='delete']").click(function(){
			...
			var url = "${ctp}/plan/chance/delete";
			var args = {"id":id};
			$.post(url, args, function(data){
				if(data == "1"){
					$("#plan-" + id).remove();
	...
	/* 	$("#execute").click(function(){
			...
			window.location.href = "${ctp}/plan/chance/execution?id=" + id;
			return false;
		}); */
...
<button class="common_button" id="execute" 
	...
	<form action="${ctp}/plan/chance/savePlan" method="post">
